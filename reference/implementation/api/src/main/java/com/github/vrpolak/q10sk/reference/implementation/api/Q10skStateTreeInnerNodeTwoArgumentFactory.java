...
/**
 * Immutable object for creating inner nodes of leaf function with two arguments.
 *
 * <p>The only reason for immutability is that *Node implementations are expected to reference *Factory objects.
 *
 * @author Vratko Polak
 */
public interface Q10skStateTreeInnerNodeTwoArgumentFactory<TARGET extends Q10skStateTreeInnerNode> {
     ...
     */
    TARGET create(final Q10skStateTreeGeneralNode argumentX, final Q10skStateTreeGeneralNode argumentY);
