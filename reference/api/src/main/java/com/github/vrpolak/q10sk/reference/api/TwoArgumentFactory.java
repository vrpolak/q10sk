...
/**
 * Immutable object for creating instances of given type using two arguments.
 *
 * @author Vratko Polak
 */
public interface TwoArgumentFactory<TARGET, ARGUMENT> {
     ...
     */
    TARGET create(final ARGUMENT argumentX, final ARGUMENT argumentY);
